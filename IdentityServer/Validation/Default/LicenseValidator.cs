...
internal class LicenseValidator
{
    ...
    public static void ValidateLicense()
    {
        ...
        else
        {
            ...
            {
                errors.Add("You have automatic key management enabled, but you do not have a valid license for that feature of IdentityServer4. Either upgrade your license or disable automatic key management by setting the KeyManagement.Enabled property to false on the IdentityServerOptions.");
            }
        }
    ...
    public static void ValidateClient(string clientId)
    {
        if (_license != null)
        {
            if (_license.ClientLimit.HasValue)
            {
                ...
                {
                    _errorLog.Invoke(
                        "Your license for IdentityServer4 only permits {clientLimit} number of clients. You have processed requests for {clientCount}. The clients used were: {clients}.",
    ...
    public static void ValidateServerSideSessions()
    {
        ...
        {
            _errorLog.Invoke("You have configured server-side sessions. Your license for IdentityServer4 does not include that feature.", Array.Empty<object>());
        }
    }
    ...
    public static void ValidateResourceIndicators(string resourceIndicator)
    {
        ...
        {
            _errorLog.Invoke("A request was made using a resource indicator. Your license for IdentityServer4 does not permit resource isolation.", Array.Empty<object>());
        }
    }
    ...
    public static void ValidateDynamicProviders()
    {
        ...
        {
            _errorLog.Invoke("A request was made invoking a dynamic provider. Your license for IdentityServer4 does not permit dynamic providers.", Array.Empty<object>());
        }
    }
    ...
    public static void ValidateCiba()
    {
        ...
        {
            _errorLog.Invoke("A CIBA (client initiated backchannel authentication) request was made. Your license for IdentityServer4 does not permit the CIBA feature.", Array.Empty<object>());
        }
    }
