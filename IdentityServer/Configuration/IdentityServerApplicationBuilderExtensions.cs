...
public static class IdentityServerApplicationBuilderExtensions
{
    ...
    internal static void Validate(this IApplicationBuilder app)
    {
        ...
        logger.LogInformation("Starting IdentityServer4 version {version} ({netversion})", typeof(IdentityServer4.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion, RuntimeInformation.FrameworkDescription);
